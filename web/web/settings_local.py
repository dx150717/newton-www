...
SUPPORT_LANGUAGES = (('id', 'Bahasa Indonesia'), ('de', 'Deutsch'), ('en', 'English'),  ('es', 'Español'), ('fr', 'Français'), ('it', 'Italiano'), ('nl', 'Nederlands'), ('tr', 'Türkçe'), ('ru', 'Pусский'), ('fi', 'suomalainen'), ('ar', 'العربية'), ('ko', '한국어'), ('ja', '日本語'), ('zh-cn', '简体中文'))
