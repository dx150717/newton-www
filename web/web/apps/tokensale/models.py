...
class KYCInfo(models.Model):
    ...
    expect_btc = models.FloatField(verbose_name=_('How much do you want to contribute in BTC'))
    expect_ela = models.FloatField(verbose_name=_('How much do you want to contribute in ELA'))
