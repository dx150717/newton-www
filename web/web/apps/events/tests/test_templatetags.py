...
from events.managers import DRAFT
from events.managers import PUBLISHED
from events.flags import PINGBACK, TRACKBACK
from events.tests.utils import datetime
from events.tests.utils import urlEqual
from events.signals import disconnect_entry_signals
from events.signals import disconnect_discussion_signals
from events.templatetags.zinnia import widont
from events.templatetags.zinnia import week_number
from events.templatetags.zinnia import get_authors
from events.templatetags.zinnia import get_gravatar
from events.templatetags.zinnia import get_tag_cloud
from events.templatetags.zinnia import get_categories
from events.templatetags.zinnia import get_categories_tree
from events.templatetags.zinnia import zinnia_pagination
from events.templatetags.zinnia import zinnia_statistics
from events.templatetags.zinnia import get_draft_entries
from events.templatetags.zinnia import get_recent_entries
from events.templatetags.zinnia import get_random_entries
from events.templatetags.zinnia import zinnia_breadcrumbs
from events.templatetags.zinnia import get_popular_entries
from events.templatetags.zinnia import get_similar_entries
from events.templatetags.zinnia import get_recent_comments
from events.templatetags.zinnia import get_recent_linkbacks
from events.templatetags.zinnia import get_featured_entries
from events.templatetags.zinnia import get_calendar_entries
from events.templatetags.zinnia import get_archives_entries
from events.templatetags.zinnia import get_archives_entries_tree
from events.templatetags.zinnia import user_admin_urlname
from events.templatetags.zinnia import comment_admin_urlname
...
class TemplateTagsTestCase(TestCase):
    ...
    def test_get_categories(self):
        ...
        self.assertEqual(context['template'], 'events/tags/categories.html')
    ...
    def test_get_categories_tree(self):
        ...
        self.assertEqual(context['template'],
                         'events/tags/categories_tree.html')
        self.assertEqual(context['context_category'], None)
    ...
    def test_get_authors(self):
        ...
        self.assertEqual(context['template'], 'events/tags/authors.html')
    ...
    def test_get_recent_entries(self):
        ...
        self.assertEqual(context['template'],
                         'events/tags/entries_recent.html')
    ...
    def test_get_featured_entries(self):
        ...
        self.assertEqual(len(context['entries']), 0)
        self.assertEqual(context['template'],
                         'events/tags/entries_featured.html')
    ...
    def test_draft_entries(self):
        ...
        self.assertEqual(len(context['entries']), 1)
        self.assertEqual(context['template'],
                         'events/tags/entries_draft.html')
    ...
    def test_get_random_entries(self):
        ...
        self.assertEqual(len(context['entries']), 0)
        self.assertEqual(context['template'],
                         'events/tags/entries_random.html')
    ...
    def test_get_popular_entries(self):
        ...
        self.assertEqual(len(context['entries']), 0)
        self.assertEqual(context['template'],
                         'events/tags/entries_popular.html')
    ...
    def test_get_similar_entries(self):
        ...
        self.assertEqual(len(context['entries']), 0)
        self.assertEqual(context['template'],
                         'events/tags/entries_similar.html')
    ...
    def test_get_archives_entries(self):
        ...
        self.assertEqual(context['template'],
                         'events/tags/entries_archives.html')
    ...
    def test_get_archives_tree(self):
        ...
        self.assertEqual(len(context['archives']), 0)
        self.assertEqual(context['template'],
                         'events/tags/entries_archives_tree.html')
    ...
    def test_get_calendar_entries_no_params(self):
        ...
        self.assertEqual(context['template'],
                         'events/tags/entries_calendar.html')
    ...
    def test_get_recent_comments(self):
        ...
        self.assertEqual(context['template'],
                         'events/tags/comments_recent.html')
    ...
    def test_get_recent_linkbacks(self):
        ...
        self.assertEqual(context['template'],
                         'events/tags/linkbacks_recent.html')
    ...
    def test_zinnia_pagination(self):
        ...
        self.assertEqual(context['template'], 'events/tags/pagination.html')
    ...
    def test_zinnia_breadcrumbs(self):
        ...
        self.assertEqual(context['breadcrumbs'][0].url,
                         reverse('events:entry_archive_index'))
        self.assertEqual(context['template'], 'events/tags/breadcrumbs.html')
        ...
        source_context = Context(
            {'request': FakeRequest(reverse('events:tag_detail',
                                            args=['test'])),
             'object': tag})
        with self.assertNumQueries(0):
            context = zinnia_breadcrumbs(source_context)
        ...
        source_context = Context(
            {'request': FakeRequest(reverse(
                'events:entry_archive_year', args=[2011]))})
        with self.assertNumQueries(0):
            context = zinnia_breadcrumbs(source_context)
        ...
        source_context = Context({'request': FakeRequest(reverse(
            'events:entry_archive_month', args=[2011, '03']))})
        with self.assertNumQueries(0):
            context = zinnia_breadcrumbs(source_context)
        self.assertEqual(len(context['breadcrumbs']), 3)
        check_only_last_have_no_url(context['breadcrumbs'])
        ...
        source_context = Context({'request': FakeRequest(reverse(
            'events:entry_archive_week', args=[2011, 15]))})
        with self.assertNumQueries(0):
            context = zinnia_breadcrumbs(source_context)
        self.assertEqual(len(context['breadcrumbs']), 3)
        check_only_last_have_no_url(context['breadcrumbs'])
        ...
        source_context = Context({'request': FakeRequest(reverse(
            'events:entry_archive_day', args=[2011, '03', 15]))})
        with self.assertNumQueries(0):
            context = zinnia_breadcrumbs(source_context)
        self.assertEqual(len(context['breadcrumbs']), 4)
        check_only_last_have_no_url(context['breadcrumbs'])
        ...
        source_context = Context({'request': FakeRequest(reverse(
            'events:entry_archive_day_paginated', args=[2011, '03', 15, 2])),
            'page_obj': FakePage(2)})
        with self.assertNumQueries(0):
            context = zinnia_breadcrumbs(source_context)
        self.assertEqual(len(context['breadcrumbs']), 5)
    ...
    def test_get_tag_cloud(self):
        ...
        self.assertEqual(context['template'], 'events/tags/tag_cloud.html')
    ...
    def test_zinnia_statistics(self):
        ...
        self.assertEqual(context['template'], 'events/tags/statistics.html')
