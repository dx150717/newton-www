...
from events.xmlrpc.metaweblog import authenticate
from events.xmlrpc.metaweblog import post_structure
from events.tests.utils import TestTransport
...
class MetaWeblogTestCase(TestCase):
        ...
        self.assertEqual(
            ...
            [{'count': 1,
             ...
             {'count': 1,
              ...
              'slug': 'events',
              'tag_id': Tag.objects.get(name='events').pk}])
    ...
    def test_new_media_object(self):
        ...
        file_.seek(0)
        media = {'name': 'events_test_file.txt',
                 'type': 'text/plain',
