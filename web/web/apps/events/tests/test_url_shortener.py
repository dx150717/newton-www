...
from events.url_shortener.backends import default
...
class URLShortenerTestCase(TestCase):
    ...
    def test_get_url_shortener(self):
        ...
        us_settings.URL_SHORTENER_BACKEND = ('events.tests.implementations.'
        ...
        us_settings.URL_SHORTENER_BACKEND = 'events.url_shortener'\
                                            '.backends.default'
        self.assertEqual(get_url_shortener(), default.backend)
