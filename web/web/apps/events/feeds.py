...
from events.settings import FEEDS_MAX_ITEMS
from events.views.categories import get_category_or_404
...
class LatestEntries(EntryFeed):
    ...
    def link(self):
        ...
        """
        return reverse('events:entry_archive_index')
...
class TagEntries(EntryFeed):
    ...
    def link(self, obj):
        ...
        URL of the tag.
        """
        return reverse('events:tag_detail', args=[obj.name])
...
class SearchEntries(EntryFeed):
    ...
    def link(self, obj):
        ...
        """
        return '%s?pattern=%s' % (reverse('events:entry_search'), obj)
