...
from events.admin.forms import CategoryAdminForm
...
class CategoryAdmin(admin.ModelAdmin):
    ...
    fields = ('title', 'parent', 'description', 'slug', 'language','entry_type')
    list_display = ('title', 'slug', 'get_tree_path', 'description','language','entry_type')
    prepopulated_fields = {'slug': ('title', )}
    search_fields = ('title', 'description', 'language','entry_type')
    list_filter = ('parent',)
