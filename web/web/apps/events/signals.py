...
ENTRY_PS_PING_DIRECTORIES = 'events.entry.post_save.ping_directories'
ENTRY_PS_PING_EXTERNAL_URLS = 'events.entry.post_save.ping_external_urls'
COMMENT_PS_COUNT_DISCUSSIONS = 'events.comment.post_save.count_discussions'
COMMENT_PD_COUNT_DISCUSSIONS = 'events.comment.pre_delete.count_discussions'
COMMENT_WF_COUNT_DISCUSSIONS = 'events.comment.was_flagged.count_discussions'
COMMENT_WP_COUNT_COMMENTS = 'events.comment.was_posted.count_comments'
PINGBACK_WP_COUNT_PINGBACKS = 'events.pingback.was_flagged.count_pingbacks'
TRACKBACK_WP_COUNT_TRACKBACKS = 'events.trackback.was_flagged.count_trackbacks'
...
def ping_external_urls_handler(sender, **kwargs):
    ...
    if entry.is_visible and settings.SAVE_PING_EXTERNAL_URLS:
        from events.ping import ExternalUrlsPinger
