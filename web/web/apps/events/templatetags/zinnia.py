...
@register.inclusion_tag('events/tags/dummy.html', takes_context=True)
def get_categories(context, template='events/tags/categories.html'):
    ...
    return {'template': template,
            'categories': Category.published.filter(language=language).annotate(
                count_entries_published=Count('entries')),
            'context_category': context.get('category')}


@register.inclusion_tag('events/tags/dummy.html', takes_context=True)
def get_categories_tree(context, template='events/tags/categories_tree.html'):
    """
...
@register.inclusion_tag('events/tags/dummy.html', takes_context=True)
def get_authors(context, template='events/tags/authors.html'):
    """
...
@register.inclusion_tag('events/tags/dummy.html')
def get_recent_entries(number=5, template='events/tags/entries_recent.html'):
    """
...
def get_featured_entries(number=5,
                         template='events/tags/entries_featured.html'):
    """
...
def get_draft_entries(number=5,
                      template='events/tags/entries_draft.html'):
    """
...
@register.inclusion_tag('events/tags/dummy.html')
def get_random_entries(number=5, template='events/tags/entries_random.html'):
    """
...
@register.inclusion_tag('events/tags/dummy.html')
def get_popular_entries(number=5, template='events/tags/entries_popular.html'):
    """
...
def get_similar_entries(context, number=5,
                        template='events/tags/entries_similar.html',
                        flush=False):
    """
...
@register.inclusion_tag('events/tags/dummy.html')
def get_archives_entries(template='events/tags/entries_archives.html'):
    """
...
def get_archives_entries_tree(
        template='events/tags/entries_archives_tree.html'):
    """
...
def get_calendar_entries(context, year=None, month=None,
                         template='events/tags/entries_calendar.html'):
    """
...
@register.inclusion_tag('events/tags/dummy.html')
def get_recent_comments(number=5, template='events/tags/comments_recent.html'):
    """
...
def get_recent_linkbacks(number=5,
                         template='events/tags/linkbacks_recent.html'):
    """
...
def zinnia_pagination(context, page, begin_pages=1, end_pages=1,
                      ...
                      template='events/tags/pagination.html'):
    """
...
def zinnia_breadcrumbs(context, root_name=_('Blog'),
                       template='events/tags/breadcrumbs.html',):
    """
...
def get_tag_cloud(context, steps=6, min_count=None,
                  template='events/tags/tag_cloud.html'):
    """
...
@register.inclusion_tag('events/tags/dummy.html')
def zinnia_statistics(template='events/tags/statistics.html'):
    """
