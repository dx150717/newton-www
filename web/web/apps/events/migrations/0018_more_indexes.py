...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_index('events_entry', ['status'])
        db.create_index('events_entry', ['start_publication'])
        db.create_index('events_entry', ['creation_date'])
        db.create_index('events_entry', ['end_publication'])
        db.create_index('events_entry', [
            'status', 'creation_date',
            'start_publication', 'end_publication'])

    def backwards(self, orm):
        db.delete_index('events_entry', [
            'status', 'creation_date',
            'start_publication', 'end_publication'])
        db.delete_index('events_entry', ['end_publication'])
        db.delete_index('events_entry', ['creation_date'])
        db.delete_index('events_entry', ['start_publication'])
        db.delete_index('events_entry', ['status'])
    ...
    models = {
        ...
        'events.category': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['events.Category']"}),
        ...
        'events.entry': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'entries'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['events.Category']"}),
            'comment_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'comment_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'content': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'content_template': ('django.db.models.fields.CharField', [], {'default': "'events/_entry_detail.html'", 'max_length': '250'}),
