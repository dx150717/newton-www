...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_entry', 'content_template',
                      self.gf('django.db.models.fields.CharField')(default='events/_entry_detail.html', max_length=250),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Entry.content_template'
        db.delete_column('events_entry', 'content_template')
