...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_entry', 'comment_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Entry.pingback_count'
        db.add_column('events_entry', 'pingback_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Entry.trackback_count'
        db.add_column('events_entry', 'trackback_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Entry.comment_count'
        db.delete_column('events_entry', 'comment_count')

        # Deleting field 'Entry.pingback_count'
        db.delete_column('events_entry', 'pingback_count')

        # Deleting field 'Entry.trackback_count'
        db.delete_column('events_entry', 'trackback_count')
