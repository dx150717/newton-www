...
from events.flags import PINGBACK
from events.flags import TRACKBACK
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        entry_content_type = orm['contenttypes.ContentType'].objects.get(
            app_label='events', model='entry')
        for entry in orm['events.Entry'].objects.all():
