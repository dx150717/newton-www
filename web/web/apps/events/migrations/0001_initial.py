...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('events', ['Entry'])

        # Adding M2M table for field sites on 'Entry'
        db.create_table('events_entry_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm['events.entry'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('events_entry_sites', ['entry_id', 'site_id'])

        # Adding M2M table for field related on 'Entry'
        db.create_table('events_entry_related', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_entry', models.ForeignKey(orm['events.entry'], null=False)),
            ('to_entry', models.ForeignKey(orm['events.entry'], null=False))
        ))
        db.create_unique('events_entry_related', ['from_entry_id', 'to_entry_id'])

        # Adding M2M table for field categories on 'Entry'
        db.create_table('events_entry_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm['events.entry'], null=False)),
            ('category', models.ForeignKey(orm['events.category'], null=False))
        ))
        db.create_unique('events_entry_categories', ['entry_id', 'category_id'])

        # Adding M2M table for field authors on 'Entry'
        db.create_table('events_entry_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm['events.entry'], null=False)),
            ('user', models.ForeignKey(orm[user_orm_label], null=False))
        ))
        db.create_unique('events_entry_authors', ['entry_id', 'user_id'])
    ...
    models = {
        ...
        'events.entry': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['events.Category']"}),
