...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('events_entry', 'end_publication', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Entry.start_publication'
        db.alter_column('events_entry', 'start_publication', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Changing field 'Entry.end_publication'
        db.alter_column('events_entry', 'end_publication', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Entry.start_publication'
        db.alter_column('events_entry', 'start_publication', self.gf('django.db.models.fields.DateTimeField')())
