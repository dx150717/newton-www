...
class KYCInfo(models.Model):
    ...
    emergency_contact_first_name = models.CharField(max_length=128, verbose_name=_('Emergency Contact First Name'))
    emergency_contact_last_name = models.CharField(max_length=128, verbose_name=_('Emergency Contact Last Name'))
