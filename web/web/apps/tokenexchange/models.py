...
class KYCInfo(models.Model):
    ...
    # profile
    personal_profile = models.TextField(verbose_name=_("Self Introduction"), max_length=10240, help_text="(*)")
    ...
    what_is_newton = models.TextField(verbose_name=_('Tell us your understanding about Newton'), max_length=10240, null=True, help_text='(*)')
    done_for_newton = models.TextField(verbose_name=_('What contribute you had do for newton'), max_length=10240)
    ...
    do_for_newton = models.TextField(verbose_name=_('What will you do for newton'), max_length=10240)
    ...
    # emergency info
    emergency_contact_first_name = models.CharField(max_length=128, verbose_name=_('First Name of Emergency Contact'), help_text="(*)")
    emergency_contact_last_name = models.CharField(max_length=128, verbose_name=_('Last Name of Emergency Contact'), help_text="(*)")
    ...
    emergency_country = CountryField(blank_label="Select country or region", verbose_name=_('Emergency Country or Region'), help_text='(*)')
    emergency_city = models.CharField(max_length=256, verbose_name=_('City'), help_text='(*)')
    emergency_location = models.CharField(max_length=1024, verbose_name=_('Emergency Address'), help_text='(*)')
    emergency_relationship = models.CharField(max_length=1024, verbose_name=_('Emergency Relationship'), help_text='(*)')
